...
EOF
  ...
  assert_contains "$out" '(base-rate (base-rate-key aToB antecedent (A $a)) (1 0.0011237357972281184))'
...
run_ffi_harness_test() {
  ...
  assert_eq "$summary" "HARNESS: 16 pass, 0 close, 0 fail" "ffi harness verdict counts"
}
